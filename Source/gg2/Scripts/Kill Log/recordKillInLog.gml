    ...
    // argument3: The source of the damage (e.g. global.DAMAGE_SOURCE_SCATTERGUN)
        ...
        with (KillLog) {
            ...
            if(argument3 == global.DAMAGE_SOURCE_PITFALL or argument3 == global.DAMAGE_SOURCE_BID_FAREWELL)
            {

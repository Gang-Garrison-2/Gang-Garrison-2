{
    ...
    sprite_assign(QuerlyRedS, QuerlyRedSP);
    ...
    sprite_assign(QuerlyBlueS, QuerlyBlueSP);
    ...
    sprite_assign(SniperRedCrouchS, SniperRedCrouchSP);
    sprite_assign(SniperBlueCrouchS, SniperBlueCrouchSP);
}
